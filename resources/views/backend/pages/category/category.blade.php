				...
				<div class="card-body">
					...
					@if($category_image)
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
									<label for="category" class="form-label">Current Category Image</label>
									
									<img src="{{ asset($category_image) }}" alt="{{ $name }}" class="previewImg" height="100px" width="100px">
								</div>
							</div>
						</div>
					@endif
					<div class="row">
						<div class="col-xs-12 col-sm-3 col-md-3">
							<div class="form-group">
								...
								<input type="file" class="allImage" name="category_image" accept="image/*" maxlength="50" accept=".png, .jpg, .jpeg" >
